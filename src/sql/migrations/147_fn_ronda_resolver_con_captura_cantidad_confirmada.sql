...
--
-- RENUMERADA de 146 a 147 el 2026-09-13, sin tocar el cuerpo: la 146 la tomó
-- `146_hato_capturas_foto` (ESCO-76), fusionada minutos después y ya APLICADA
-- a producción, así que ese número no se puede mover sin dejar el fichero
-- desalineado del ledger. Ésta todavía no se aplica, así que renumerarla no
-- cuesta nada. Es la cuarta colisión de número en tres semanas por ramas
-- abiertas en paralelo: el barrido de ramas del runbook no ve una rama que se
-- abre DESPUÉS del barrido.
--
