...
import { calcularMesesPrenez, descomponerSX, parseUltimaCria, type EventoDerivado, type ParseIssue } from '@/utils/calculosHato';
import type { FilaChequeoNormalizada } from './tipos';
import type { ClasificacionFilaDiff, FilaChequeoVacaHistorico, ResultadoDiffChequeo } from './diffChequeo';
