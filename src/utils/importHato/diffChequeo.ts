...
import type { AnimalEnChequeo } from '@/utils/calculosHato';
import { detectarColisionesChapeta } from '@/utils/calculosHato';
import { esNumeroProvisional } from './overridesChapeta';
import type { FilaChequeoNormalizada, ParseIssue, TipoEstado } from './tipos';
