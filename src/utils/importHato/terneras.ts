...
import type { ParseIssue } from '@/utils/calculosHato';
import { parseFechasServicio, parseValorNumerico } from '@/utils/calculosHato';
import type { HojaCruda, FilaTerneraNormalizada, ConfianzaFecha } from './tipos';
import { valorCeldaATexto, valorFechaATexto, esVacio } from './celdas';
