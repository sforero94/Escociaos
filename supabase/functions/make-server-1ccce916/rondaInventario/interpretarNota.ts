// ARCHIVO: supabase/functions/make-server-1ccce916/rondaInventario/interpretarNota.ts
// GENERADO por docs/inventario/regenerar-copias-ronda-inventario.py -- NUNCA
// edites este archivo a mano. Editá `src/utils/rondaInventario/interpretarNota.ts` y volvé a correr el script.
//
...
import { CAUSAS_RAIZ, type CausaRaiz, type ViaExcepcion } from './causasRaiz.ts';
