// ARCHIVO: supabase/functions/make-server-1ccce916/rondaInventario/resolucion.ts
// GENERADO por docs/inventario/regenerar-copias-ronda-inventario.py -- NUNCA
// edites este archivo a mano. Editá `src/utils/rondaInventario/resolucion.ts` y volvé a correr el script.
//
...
import { causaPorIndice, indiceDeCausa } from './causasRaiz.ts';
