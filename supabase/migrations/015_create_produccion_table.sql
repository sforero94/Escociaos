...
DROP POLICY IF EXISTS "Allow authenticated read access on produccion" ON produccion;
DROP POLICY IF EXISTS "Allow authenticated insert on produccion" ON produccion;
DROP POLICY IF EXISTS "Allow authenticated update on produccion" ON produccion;
DROP POLICY IF EXISTS "Allow authenticated delete on produccion" ON produccion;
